...
import { CartProvider } from "@/lib/crestmark-cart";
import { CrestmarkShell } from "@/components/CrestmarkChrome";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Crestmark Enterprises" },
      { property: "og:title", content: "Crestmark Enterprises | Quality Soy. Trusted Nutrition." },
      {
        property: "og:description",
        content:
          "Crestmark Enterprises manufactures premium soy-based food products in Zimbabwe.",
      },
